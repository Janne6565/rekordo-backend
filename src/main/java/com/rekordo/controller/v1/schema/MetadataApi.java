...
public interface MetadataApi {
    ...
    @Operation(
            ...
            description = "Read from the mirror, and from MusicBrainz exactly once per release — "
                    ...
                    + "An Apple Music album (`applemusic:<id>`, which is what a copy picked from the "
                    + "album search names when no pressing was chosen) is read from Apple instead: "
                    + "one medium per disc, numbered 1..n, with no medium format.\n\n"
